...
Section zoo_G.
  ...
  Proof.
    iIntros "%Φ _ HΦ".
    wp_apply (xdeque٠create𑁒spec with "[//]").
    iSteps.
  Qed.
  ...
  Proof.
    ...
    wp_apply (xdeque٠is_empty𑁒spec with "Hmodel").
  ...
  Proof.
    ...
    wp_apply (xdeque٠push_front𑁒spec with "[$Hmodel $Hnode_prev $Hnode_next]").
    iSteps.
  Qed.
  ...
  Proof.
    ...
    wp_rec.
    wp_block node as "(Hnode_prev & Hnode_next & Hnode_data & _)".
    wp_apply (xdeque٠push_back𑁒spec with "[$Hmodel $Hnode_prev $Hnode_next]").
  ...
  Proof.
    iIntros "%Φ (%nodes & Hmodel & Hnodes) HΦ".
    wp_rec.
    wp_apply (xdeque٠pop_front𑁒spec with "Hmodel") as "Hmodel".
  ...
  Proof.
    iIntros "%Φ (%nodes & Hmodel & Hnodes) HΦ".
    wp_rec.
    wp_apply (xdeque٠pop_back𑁒spec with "Hmodel") as ([node |]) "Hmodel".
