...
Notation next := (  in_type "zoo_std.queue_2.node.Node" 0
) (only parsing).
Notation "'next'" := (
  in_type "zoo_std.queue_2.node.Node" 0
)(in custom zoo_field
).
Notation data := (  in_type "zoo_std.queue_2.node.Node" 1
) (only parsing).
Notation "'data'" := (
...
Notation front := (  in_type "zoo_std.queue_2.t" 0
) (only parsing).
Notation "'front'" := (
  in_type "zoo_std.queue_2.t" 0
)(in custom zoo_field
).
Notation back := (  in_type "zoo_std.queue_2.t" 1
) (only parsing).
Notation "'back'" := (
