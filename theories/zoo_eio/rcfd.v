...
Section rcfd_G.
  ...
  Proof.
    ...
    - iDestruct (inv_lstate_LClosing with "Hlstate Hlstate_auth") as "(%fn2 & -> & #Hlstate_lb)"; first done.
      ...
      wp_apply+ (rcfd٠finish𑁒spec with "[$] HΦ").
  Qed.
  ...
  Proof.
    ...
    - iDestruct (inv_lstate_LClosing with "Hlstate Hlstate_auth") as "#(%fn2 & -> & _)"; first done.
      ...
      wp_apply+ (rcfd٠put𑁒spec with "[$]") as "_".
      wp_pures.
      iApply ("HΦ" $! None).
      destruct spec; try congruence; iSteps.
  Qed.
  ...
  Proof.
    ...
    wp_apply (rcfd٠get𑁒spec_aux SpecNormal with "[$]").
    iSteps.
  Qed.
  ...
  Proof.
    ...
    wp_apply (rcfd٠get𑁒spec_aux SpecOwner with "[$]") as ([v |]) ""; last iSteps.
    iSteps.
  Qed.
  ...
  Proof.
    ...
    wp_apply (rcfd٠get𑁒spec_aux SpecClosing with "[$]").
    iSteps.
  Qed.
  ...
  Proof.
    ...
    wp_rec.
    wp_apply+ (rcfd٠get𑁒spec_aux with "[$]") as ([v |]) "(Hspec & H)".
    ...
    - iDestruct "H" as "(%q & -> & Htoken & HΨ)".
      ...
      wp_apply+ (rcfd٠put𑁒spec with "[Htoken HΨ]") as "_"; first iSteps.
      wp_pures.
      destruct spec; try congruence; iSteps.
  ...
  Proof.
    ...
    wp_apply (rcfd٠use𑁒spec_aux SpecNormal with "[$]").
    iSteps.
  Qed.
  ...
  Proof.
    ...
    wp_apply (rcfd٠use𑁒spec_aux SpecOwner (const Χ) with "[$]").
    iSteps.
  Qed.
  ...
  Proof.
    ...
    wp_apply (rcfd٠use𑁒spec_aux SpecClosing (const Χ) with "[$]").
    iSteps.
  Qed.
  ...
  Proof.
    ...
    - iDestruct "Hlstate" as "(:inv_lstate_open =1)".
      ...
      + destruct state2; last zoo_simplify.
        ...
        wp_apply+ (rcfd٠finish𑁒spec with "[$]").
  ...
  Proof.
    ...
    wp_apply (rcfd٠close𑁒spec_aux false with "[$]").
    iSteps.
  Qed.
  ...
  Proof.
    ...
    wp_apply (rcfd٠close𑁒spec_aux true with "[$]").
    iSteps.
  Qed.
  ...
  Proof.
    ...
    - iDestruct "Hlstate" as "(:inv_lstate_open =1)".
      ...
      wp_apply+ (spsc_waiter٠create𑁒spec (Ψ 1%Qp) with "[//]") as "%waiter (#Hwaiter_inv & Hwaiter_producer & Hwaiter_consumer)".
      wp_pures.
      ...
      + destruct state2; last zoo_simplify.
        ...
        { destruct_decide (ops2 = 0) as -> | ?.
          - iDestruct (tokens_auth_consume with "Htokens_auth") as "HΨ".
            ...
            wp_apply (spsc_waiter٠notify𑁒spec with "[$Hwaiter_inv $Hwaiter_producer $HΨ]").
            iSteps.
          - iDestruct (tokens_auth_valid with "Htokens_auth") as %?.
        ...
        wp_apply+ (spsc_waiter٠wait𑁒spec with "[$Hwaiter_inv $Hwaiter_consumer]") as "HΨ".
        wp_pures.
        iApply ("HΦ" $! (Some _)).
        destruct γ.(metadata_owned); iSteps.
  ...
  Proof.
    ...
    wp_apply (rcfd٠remove𑁒spec_aux false with "[$]").
    iSteps.
  Qed.
  ...
  Proof.
    ...
    wp_apply (rcfd٠remove𑁒spec_aux true with "[$]").
    iSteps.
  Qed.
  ...
  Proof.
    ...
    wp_apply (rcfd٠is_open𑁒spec_aux SpecNormal with "[$]").
    iSteps.
  Qed.
  ...
  Proof.
    ...
    wp_apply (rcfd٠is_open𑁒spec_aux SpecOwner with "[$]").
    iSteps.
  Qed.
  ...
  Proof.
    ...
    wp_apply (rcfd٠is_open𑁒spec_aux SpecClosing with "[$]").
    iSteps.
  Qed.
  ...
  Proof.
    ...
    wp_apply (rcfd٠peek𑁒spec_aux SpecNormal with "[$]").
    iSteps.
  Qed.
  ...
  Proof.
    ...
    wp_apply (rcfd٠peek𑁒spec_aux SpecOwner with "[$]").
    iSteps.
  Qed.
  ...
  Proof.
    ...
    wp_apply (rcfd٠peek𑁒spec_aux SpecClosing with "[$]").
    iSteps.
  Qed.
End rcfd_G.
