...
Notation casn := (  in_type "zoo_kcas.kcas_2.state" 0
) (only parsing).
Notation "'casn'" := (
  in_type "zoo_kcas.kcas_2.state" 0
)(in custom zoo_field
).
Notation before := (  in_type "zoo_kcas.kcas_2.state" 1
) (only parsing).
Notation "'before'" := (
  in_type "zoo_kcas.kcas_2.state" 1
)(in custom zoo_field
).
Notation after := (  in_type "zoo_kcas.kcas_2.state" 2
) (only parsing).
Notation "'after'" := (
...
Notation status := (  in_type "zoo_kcas.kcas_2.casn" 0
) (only parsing).
Notation "'status'" := (
  in_type "zoo_kcas.kcas_2.casn" 0
)(in custom zoo_field
).
Notation proph := (  in_type "zoo_kcas.kcas_2.casn" 1
) (only parsing).
Notation "'proph'" := (
