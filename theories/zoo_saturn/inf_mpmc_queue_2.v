...
Module base.
  Section inf_mpmc_queue_2_G.
    ...
    Proof.
      ...
      awp_apply (inf_mpmc_queue_2٠size𑁒spec with "Hinv").
    ...
    Proof.
      ...
      - rewrite Nat.max_r // in Hlstates1.
        ...
        + iMod (history_update (Some v) with "Hhistory_auth") as "(Hhistory_auth & #Hhistory_at)". rewrite Hhist1.
          ...
          wp_apply (inf_array٠cas_resolve𑁒spec with "Hdata_inv"); first lia.
    ...
    Proof.
      ...
      - rewrite drop_ge /= in Hvs1; first lia. subst vs1.
        ...
        + iMod (lstates_update ConsumerConsumer with "Hlstates_auth") as "(Hlstates_auth & #Hlstates_lb & _)". rewrite Hlstates1.
          ...
          wp_apply (inf_array٠xchg_resolve𑁒spec with "Hdata_inv"); first lia.
          iMod (inv_acc with "Hinv") as "((:inv_inner =2) & Hclose1)"; first done.
...
Section inf_mpmc_queue_2_G.
  ...
  Proof.
    ...
    iApply wp_fupd.
    wp_apply (base.inf_mpmc_queue_2٠create𑁒spec with "[//]") as (𝑡 γ) "(Hmeta & Hinv & Hmodel)".
  ...
  Proof.
    ...
    awp_apply (base.inf_mpmc_queue_2٠size𑁒spec with "[$]").
  ...
  Proof.
    ...
    awp_apply (base.inf_mpmc_queue_2٠is_empty𑁒spec with "[$]").
    { iApply (aacc_aupd_commit with "HΦ"); first done. iIntros "%vs (:model =1)". simplify.
      iDestruct (meta_agree with "Hmeta Hmeta_1") as %<-. iClear "Hmeta_1".
      iAaccIntro with "Hmodel_1"; iSteps.
    }
  ...
  Proof.
    ...
    awp_apply (base.inf_mpmc_queue_2٠push𑁒spec with "[$]").
    { iApply (aacc_aupd_commit with "HΦ"); first done. iIntros "%vs (:model =1)". simplify.
      iDestruct (meta_agree with "Hmeta Hmeta_1") as %<-. iClear "Hmeta_1".
      iAaccIntro with "Hmodel_1"; iSteps.
    }
  ...
  Proof.
    ...
    awp_apply (base.inf_mpmc_queue_2٠pop𑁒spec with "[$]").
    { iApply (aacc_aupd_commit with "HΦ"); first done. iIntros "%vs (:model =1)". simplify.
      iDestruct (meta_agree with "Hmeta Hmeta_1") as %<-. iClear "Hmeta_1".
      iAaccIntro with "Hmodel_1"; iSteps.
    }
